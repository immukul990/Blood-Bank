...
We request donors to update contact details regularly.</p>
    ...
    <marquee direction="up" scrolldelay="160"><table >
<tr><td>
                         <div class="blog_desc">
						<div class="blog_heading">
							<span style="font-weight:bold"><b>Blood donation: India has a shortage</b>
<p>According to the World Health Organization (WHO), India suffers from an annual deficit of two million blood units, as only 1% of Indian population donates blood each year.</p></span>
							
						 </div>	
                         <br />
              <span style="font-weight:bold"><b>Facebook’s new blood donation makes it even easier to make a lifesaving donation</b>
<p>Since its 2017 launch, the Blood Donations feature has performed well. More than 35 million people signed up in the handful of worldwide markets where it was first available. In India, blood donation centers said that 20% of people said Facebook influenced their decision to donate — a statistic based on in-person surveys conducted at the blood banks.</p></span> 

                        <br />
              <span style="font-weight:bold"><b>Blood transfusion service in India continues to be unorganized and fragmented</b>
<p>The WHO estimates that blood donation by 1% of the population is generally the minimum to meet a nation’s most basic need for blood. In India’s case, as per the data of 2016-17, there was a shortage of 1.9 million units (or 15%) vis-à-vis the WHO norm.</p></span>
...
<div class="footer">
	<div class="f_nav">
		<ul>
            ...
            <li><a href="Admin/admimlogin.php">Admin log In</a></li>
