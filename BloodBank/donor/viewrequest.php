...
<div style="height:300px; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
 ...
 <tr style="background-color:bisque" align="center" class="bold">            
             <td class="bold" style="color:black"  >Request id</td><td align="center">Name</td><td align="center">Gender</td><td align="center">Age</td><td align="center">Mobile No</td><td align="center">Email</td><td align="center">Blood Group ID</td>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">Designed by Mukul & Amit</p>
		</div>
	<div class="clear"></div>
</div>
</div>
